# Experiment 2: Python Environment, Data Types, Operators, and Basic Input/Output
## Title
...
These interfaces allow users to write code, execute instructions, and view results interactively.
...
Examples include Python Shell, Jupyter Notebook cells, and Google Colab
b) Script Mode
